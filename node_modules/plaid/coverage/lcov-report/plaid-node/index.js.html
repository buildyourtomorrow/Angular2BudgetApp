...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (options.body != null) {
<span class="cstat-no" title="statement not covered" >    $requestOptions = R.assoc('body', options.body, $requestOptions);</span>
  }
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Tue Oct 04 2016 17:50:59 GMT-0700 (PDT)
</div>
</div>
